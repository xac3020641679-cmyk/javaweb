  ...
  <div class="container mt-4">
    ...
    <div v-else>
      ...
      <div class="text-center">
        <button class="btn btn-primary me-2" @click="$router.push('/manager/menu-form/' + menu.id)">
          编辑菜单
        </button>
        <button class="btn btn-secondary" @click="$router.push('/manager/menu-management')">
          返回菜单列表
        </button>
      </div>
    </div>
